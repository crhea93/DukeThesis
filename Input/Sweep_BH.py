...
# FILES FOR INPUT
mesh = '/home/clr56/Documents/DukeThesis/Mesh/bigDisk10k'
MooseFile = '/home/clr56/Documents/DukeThesis/bat/input/RadialBH.i'
...
def Init_FF(Sim_name,ResultsDir,MooseFileDir,MooseFile,Mesh,Porosity_File,Init_Press,mui):
    ...
    lines_to_change = [3,69,137,142,147,152,173,178,183,188,211]
...
def Update_Moose_after_Init(Sim_name,ResultsDir,Mesh,MooseFile,Porosity_File):
    ...
    lines_to_change = [137,142,147,152]
