...
ResultsDir = '/media/clr56/Data/Results/FrontCapPor/'
# FILES FOR INPUT
...
Name_of_Sim = 'FrontCapPor'
# VALUES FOR INPUT
initial_press = 0.0+10**(-5)
number_particles = 100
number_times = 100
particle_diameter = 0.05
Porosity_Boolean = True #Update porosity or not
...
def Init_FF(Sim_name,ResultsDir,MooseFileDir,MooseFile,Mesh,Porosity_File,Init_Press,mui):
    ...
    lines_to_change = [3,73,110,115,120,125,146,151,156,161,187]
...
def Update_Lammps_Init(Sim_name,ResultsDir,LammpsFileDir,LammpsFile,ParticlesInput,Diameter,DomainVals):
    ...
    Hookean = 'pair_style 	hooke/cap ${kn} ${kt} ${gamma_n} ${gamma_t} ${coeffFric} 0  5.0 5.0 0.078 0.01 50.0 '+ResultsDir+Sim_name+'/SaturationInterpolated.txt'
