...
def square_lattice(x_min,x_max,y_min,y_max,x_parts,y_parts,num_particles,outer_Rad,part_rad,output):
    particles = []
    ...
    for i in range(len(x)):
        for j in range(len(y)):
            ...
            if particle_within(outer_Rad,new_particle,part_rad) == False:
                pass
            else:
...
square_lattice(-0.49,0.49,-0.49,0.49,100,100,10000,0.5,0.005,'/home/crhea/Documents/DukeThesis/ParticleFiles/lammps_full_disk.lj')
